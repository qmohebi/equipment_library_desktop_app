...
"")
        ...
        self.gridLayout.addWidget(self.side_menu_2, 0, 0, 2, 1)
        ...
        self.btn_confirm.setFont(font6)
        ...
        self.verticalLayout_10.setContentsMargins(-1, -1, 100, 30)
        ...
        self.chkbx_rtls_batt = QCheckBox(self.groupBox_8)
        ...
        self.gridLayout_4.addWidget(self.chkbx_rtls_batt, 2, 1, 1, 1)
        ...
        self.txt_reported_fault.setFont(font8)
        ...
        self.gridLayout_9.addItem(self.horizontalSpacer_14, 0, 1, 1, 1)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/clear_30.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_clear_2.setIcon(icon10)
...
"}")
        ...
        QWidget.setTabOrder(self.chkbx_batt_replace, self.chkbx_rtls_batt)
        QWidget.setTabOrder(self.chkbx_rtls_batt, self.txt_work_done)
        ...
        QWidget.setTabOrder(self.txt_reported_fault, self.btn_user)
