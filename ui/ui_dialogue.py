...
"}")
        ...
        self.btn_confirm.setMinimumSize(QSize(150, 0))
        ...
        self.verticalLayout_6.addWidget(self.chkbx_visual_insp)
        ...
        self.verticalLayout_6.addWidget(self.chkbx_function)
        ...
        self.verticalLayout_6.addWidget(self.chkbx_batt_replace)
        ...
        self.txt_reported_fault = QPlainTextEdit(self.groupBox_3)
        ...
        self.rb_ppm = QRadioButton(self.groupBox_7)
        self.rb_ppm.setObjectName(u"rb_ppm")
        self.rb_ppm.setFont(font)

        self.verticalLayout_5.addWidget(self.rb_ppm)

        self.rb_job = QRadioButton(self.groupBox_7)
        self.rb_job.setObjectName(u"rb_job")
        self.rb_job.setFont(font)

        self.verticalLayout_5.addWidget(self.rb_job)
        ...
        QWidget.setTabOrder(self.rb_create_job, self.txt_work_done)
        QWidget.setTabOrder(self.txt_work_done, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.rb_ppm)
        QWidget.setTabOrder(self.rb_ppm, self.rb_job)
        QWidget.setTabOrder(self.rb_job, self.txt_category)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btn_submit.setText(QCoreApplication.translate("Dialog", u"Submit", None))
        ...
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Current Loan Location", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", u"Equipment No:", None))
        self.groupBox_6.setTitle(QCoreApplication.translate("Dialog", u"Technician", None))
        ...
        self.groupBox_8.setTitle(QCoreApplication.translate("Dialog", u"Checks", None))
        ...
        self.groupBox_7.setTitle(QCoreApplication.translate("Dialog", u"Job Type", None))
